...
const CallBlock = (props) => {
  ...
  return (
    <Parallax
      bgImage={image}
      strength={200}
      bgImageStyle={{ opacity: "100%" }}
      className={styles.root}>
      <div ref={props.h2ref} style={{ height: "600px" }}>
        <div className={styles.content}>
          <p>Не знаете, что выбрать?</p>
          <h1>
            Позвоните нам или оставьте заявку любым удобным для Вас способом
          </h1>
          <p>
            Свяжитесь с нашим специалистом и он проконсультирует Вас! Также Вы
            можете заказать онлайн замер и посчитать бюджет на облицовку Вашего
